...
The system MUST support playlist listing and active playlist selection in MVP, while playlist mutation operations may be unavailable.
...
- **WHEN** a client calls create, update, or delete playlist operations not implemented in MVP
