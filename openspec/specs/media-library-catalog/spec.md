# Media Library Catalog Specification

## Purpose
Define startup discovery and metadata behavior for supported audio files in the mounted music library.
...
### Requirement: Catalog exposes track metadata
