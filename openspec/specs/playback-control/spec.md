# Playback Control Specification

## Purpose
Define the server-maintained playback context and entity-driven controls for track selection, transport, modes, and position.
