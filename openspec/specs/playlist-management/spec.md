...
## Purpose
Define the persistent playlist lifecycle: durable user-created playlists that reference shared registry tracks, support full client-driven mutation, and carry per-playlist playback modes.
