...
public class TrackEntity {
    ...
    public TrackEntity(String id, String kind, Long durationSeconds, String relativePath, String format,
                       String sourceUrl, String streamUrl, Long expiresAfter, boolean failing,
                       String errorKind, String errorMessage, Long errorAt, String errorReporter) {
        this.id = id;
        this.kind = kind;
